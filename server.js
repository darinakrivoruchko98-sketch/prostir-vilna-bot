...
const VIOLENCE_HELP_BUTTONS = {
    hotlines: 'ГАРЯЧІ ЛІНІЇ ТА ТЕЛЕФОНИ ДОВІРИ',
    police: 'ПОЛІЦІЯ',
...
async function processParsedEvents(parsedEvents) {
    ...
    function buildViolenceHelpKeyboard() {
        return [
            [{ text: VIOLENCE_HELP_BUTTONS.hotlines }],
            [{ text: VIOLENCE_HELP_BUTTONS.police }],
...
📲 Відповідь: натисніть на повідомлення → Reply
    ...
    if (matchesCommand(text, MAIN_MENU_BUTTONS.violenceHelp, 'Допомога при насильстві')) {
        ...
        await bot.sendMessage(chatId,
            '🚨 <b>Допомога при насильстві</b>\n\nТут ви можете знайти допомогу та підтримку, якщо опинилися у складній ситуації 💛\n\n☎️ Гарячі лінії та телефони довіри\n👮 Поліція\n🛑 Спеціалізовані служби\n💛 Соціально-психологічна допомога\n🧭 Координація та адміністративна допомога\n⚖️ Правова допомога\n🏥 Медична допомога', {
            parse_mode: 'HTML',
            reply_markup: {
...
📱 Мобільний застосунок для виклику поліції
Зручно для швидкого звернення у випадку небезпеки або насильства.
👉 https://t.me/female_app_bot
...
4. Денний центр соціально-психологічної допомоги (структурний підрозділ КЗ «Кризовий центр для жінок «З надією в майбутнє»)

📍 м. Кривий Ріг, вул. Вадима Гурова, 43
📞 +38 (096) 965 85 27
⏰ пн–пт 08:00–17:00

5. Притулок для постраждалих від ГЗН жінок з дітьми (КЗ «Кризовий центр для жінок, постраждалих від насильства в сім’ї «З надією в майбутнє»)
...
💬 <b>Консультативні та денні служби</b>
...
2. Денний центр соціально-психологічної допомоги (Кам’янський ЦНСП)

📍 м. Кам’янське, просп. Свободи, 36
📞 +38 (050) 173 68 14
⏰ пн–чт 08:00–17:00, пт 08:00–15:45

3. Кризова кімната Norwegian People’s Aid (NPA) / ГО «М.АРТ.ІН-клуб»
...
6. Денний центр для постраждалих від ГЗН (Васильківська селищна рада)

📍 смт. Васильківка, вул. Успішна, 160
📞 +38 (096) 948 08 09
⏰ пн–пт 08:00–17:00

7. Кризова кімната при Денному центрі (Васильківська селищна рада)
